                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    if(!($select->select_detail_buku_besar($tanggal_awal, $tanggal_akhir, $id_account))) {
                      ?>
                      <tr class="odd">
                        <td valign="top" colspan="5" class="dataTables_empty" align="center">Maaf, Data yang kamu cari tidak ada gan !</td>
                      </tr>
                      <?php
                    }
                    ?>
                    ...
                    <tr style="background-color: #ddd;"">
                      ...
                      <td colspan="2" align="center"><strong><?php echo number_format($total_debit - $total_kredit,0,',','.'); ?></strong></td>
                    </tr>
                  </tbody>
                </table>
              </div>
