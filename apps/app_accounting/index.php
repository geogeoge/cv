...
if(isset($_POST['posting_kas_keluar'])){
  $insert->posting_kas_keluar();
}

if(isset($_POST['posting_kas_masuk'])){
  $insert->posting_kas_masuk();
}

if(isset($_POST['post_jurnal_umum'])){
  $insert->post_jurnal_umum();
}

if(isset($_POST['edit_jurnal_umum'])){
    $edit->edit_jurnal_umum();
}

if(isset($_POST['edit_account_buku_besar'])){
    $edit->edit_account_buku_besar();
}
...
<head>
  ...
  <title>Accounting | Connectis</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="#modal_pindah_app" role="button"  data-target = "#modal_pindah_app" data-toggle="modal" class="logo">
      ...
      <span class="logo-mini"><font size="6"><strong>C</strong></font></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><font size="6"><strong>CONNECTIS</strong></font></span>
    </a>
