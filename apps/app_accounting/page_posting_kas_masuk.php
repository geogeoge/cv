            ...
            <div class="row">
              ...
              <div class="col-sm-10">
                <div id="example1_filter" class="dataTables_filter">
                  ...
                  &nbsp
                  <label>
                    <button name="page" value="page_posting_kas_masuk" class="btn"><i class="fa fa-search"></i></button>
                  </label>
            ...
            <div class="row">
              ...
              <form method="POST">
                <table class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php
                     foreach ($select->select_data_temp_where('67', 'i', $tanggal_awal, $tanggal_akhir, $limit, 'belum') as $data) {
                    ?>
                    <tr>
                      ...
                      <td align="left">
                        <select class="select2" name=data_kredit[]>
                          <option selected="selected" value="xxx"></option>
                          <?php 
                          foreach ($select->select_account_posting('6') as $kredit) {
                            ?>
                            <option value="<?php echo $kredit['id_account'];?>"><?php echo $kredit['nama_account'];?></option>
                            <?php 
                          }
                          ?>
                          <?php 
                          foreach ($select->select_account_posting('7') as $kredit) {
                            ?>
                            <option value="<?php echo $kredit['id_account'];?>"><?php echo $kredit['nama_account'];?></option>
                            <?php 
                          }
                    ...
                    if(!($select->select_data_temp_where('67', 'i', $tanggal_awal, $tanggal_akhir, $limit, 'belum'))) {
                      ?>
                      <tr class="odd">
                      ...
                      ?>
                      <tr>
                        <td colspan="5" align="right"><input type="submit" name="posting_kas_masuk" value="POST" class="btn btn-primary"></td>
                      </tr>
                      <?php
                    }
                    ?>
              ...
              <div class="col-sm-7">
                <div class="dataTables_paginate paging_simple_numbers" id="example2_paginate">
                  <ul class="pagination">
                    ...
                    ?>
                    <li class="paginate_button previous" id="example2_previous"><a href="?page=page_posting_kas_masuk&tanggal_awal=<?php echo $tanggal_page?>&tanggal_akhir=<?php echo $tanggal_page?>&limit=<?php echo $limit?>" aria-controls="example2" data-dt-idx="0" tabindex="0">Awal Bulan</a></li>
                    <?php
                    ...
                    if($tanggal_akhir>=$tanggal_hari_ini_kurangi_6){
                      ...
                      for ($i= 1; $i <= 7; $i++) {
                        ...
                        ?>
                        <li class="paginate_button <?php echo $active; ?>"><a href="?page=page_posting_kas_masuk&tanggal_awal=<?php echo $tanggal_page; ?>&tanggal_akhir=<?php echo $tanggal_page; ?>&limit=<?php echo $limit?>" aria-controls="example2" data-dt-idx="1" tabindex="0"><?php echo $tanggal_tok; ?></a></li>
                        <?php
                    ...
                    <li class="paginate_button next" id="example2_next"><a href="?page=page_posting_kas_masuk" aria-controls="example2" data-dt-idx="7" tabindex="0">Hari Ini</a></li>
                  </ul>
                </div>
              </div>
            </div>
